...
export abstract class AbstractObjectControls extends THREE.Controls<ObjectControlsEventMap> {
  ...
  constructor(camera: THREE.Object3D, domElement?: HTMLElement | null) {
